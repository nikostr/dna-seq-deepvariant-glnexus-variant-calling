...
def test_bwa_index():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        # dbg
        print("resources/genome.fasta.amb resources/genome.fasta.ann resources/genome.fasta.bwt resources/genome.fasta.pac resources/genome.fasta.sa", file=sys.stderr)
